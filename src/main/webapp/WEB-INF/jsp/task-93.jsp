...
<head>
    ...
    <link rel="stylesheet" href="/task5/css/task-93.css">
...
<body>
    ...
    <header>
        <div class="top w">
            ...
            用户：<span><i>${cookie.name.value}</i></span>
            <span><li><a href="/task5/logout" class="btn">退出</a></li></span>
            <div class="logos">
        ...
        <nav>
            <ul class=" nav1 w">
                ...
                <li><a href="/task5/task-91">首页</a></li>
                <li><a href="/task5/u/task-93">职业</a></li>
                <li><a href="/task5/task-92">推荐</a></li>
                <li><a href="">关于</a></li>
            </ul>
            <div class="dropdown">
            ...
            <div class="section1 w row">
                ...
                <div class="content">
                    <div class="people col-md-4 col-sm-12 col-xs-12">
                        ...
                        <div class="first">
                            <img src=/task5${profession.img} alt="">
                            <div class="txt">
                                <p>${profession.job}</p>
                        ...
                        <div class="sec">
                            <div class="menk">门槛
                                ...
                                <img src="/task5/images/star.png" alt="">
                                </c:forEach>
                            </div>
                            <div class="nan">难易程度
                ...
                <div class="content">
                    <div class="people col-md-4 col-sm-12 col-xs-12">
                        <div class="first">
                            <img src="/task5/images/tx1.jpg" alt="">
                            <div class="txt">
                                <p>后端工程师</p>
